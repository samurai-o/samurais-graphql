  ...
  return regeneratorRuntime.async(function bootstrap$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          _context.next = 6;
          return regeneratorRuntime.awrap(client.list('/home/node/source')["catch"](function () {
            return [];
          }));
        ...
        case 6:
          ...
          _context.next = 10;
          return regeneratorRuntime.awrap(client.mkdir('/home/node/source/prisma'));

        case 10:
          _context.next = 12;
          return regeneratorRuntime.awrap(client.mkdir('/home/node/source/env'));

        case 12:
          _context.next = 14;
          return regeneratorRuntime.awrap(client.mkdir('/home/node/source/logs'));

        case 14:
          _context.next = 16;
          return regeneratorRuntime.awrap(client.uploadDir(join(process.cwd(), 'prisma'), '/home/node/source/prisma'));

        case 16:
          _context.next = 18;
          return regeneratorRuntime.awrap(client.uploadDir(join(process.cwd(), 'env'), '/home/node/source/env'));
